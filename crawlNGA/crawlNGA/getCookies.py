...
headers = {"Accept": "text/html, application/xhtml+xml, application/xml; q=0.9, */*; q=0.8",
           ...
           "Referer": "http://bbs.nga.cn/thread.php?fid=-7&page=2&rand=622",
...
headers2 = [("Accept", "text/html, application/xhtml+xml, application/xml; q=0.9, */*; q=0.8"),
           ("Host", "bbs.nga.cn"),
           ("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.140 Safari/537.36 Edge/18.17763"),
           ("Referer", "http://bbs.nga.cn/thread.php?fid=-7&page=2&rand=879"),
           ("Upgrade", "Insecure - Requests: 1"),
           ("Cookie", cookies)]
...
responseBs = BeautifulSoup(response)
print(responseBs.title.name)
